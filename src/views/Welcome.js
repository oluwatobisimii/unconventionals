...
const Welcome = () => {
  return (
    <div>
      ...
      <section className="h-screen md:h-[100vh] lg:h-screen w-screen bg-top flex items-end justify center relative overflow-hidden bg-cover bg-no-repeat bg-[url('../src/assets/images/heroImg.png')]">
        <div className="blackGradient  w-full  md:flex items-center relative z-10 pb-[40px]">
          <div className="container mx-auto">
            <div className="flex flex-col space-y-5 lg:space-y-14 items-center justify-center p-10 mt-40">
              <p className="text-5xl md:text-7xl lg:text-8xl xl:text-9xl font-serifbold lg:leading-10 text-center text-gray-50 font-BonVivant block ">
                We are <br />
                Getting Married!
              </p>
